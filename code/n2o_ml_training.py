# -*- coding: utf-8 -*-
"""
Created on Mon Apr 20 15:43:14 2026
...
#%%读取
n2o = pd.read_excel('/data/n2oXY.xlsx')

n2odf = n2o.copy()

#%%乱序
n2odf = sklearn.utils.shuffle(n2odf,random_state=2022) 
n2odf.index = range(0,len(n2odf))
...
param_grid = {
    'n_estimators': [250],  # List of integers to try
